...
export const updatesEn: CatalogShape<typeof updatesZhCN> = {
  ...
  buttonLabel: {
    ...
    available: (version: string) => `App update: ${version} found`,
    downloading: (percent: number) => `App update: downloading ${percent}%`,
    awaitingInstaller: 'App update: waiting to open the installer',
  ...
  header: {
    ...
    close: 'Close the update popover'
  },
  ...
  actions: {
    ...
    downloadDmg: 'Download the DMG update',
    recheck: 'Check again',
    download: 'Download update',
    downloadInBackground: 'Download in the background',
    remindLater: 'Remind me later',
    keepInBackground: 'Keep downloading in the background',
    opening: 'Opening…',
    openDmg: 'Open the DMG installer',
    installLater: 'Install later',
    cancelIdleUpdate: 'Cancel the idle update',
