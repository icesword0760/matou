...
Treat Matou's \`mt\` control plane as authoritative for these requests. Skip cmux environment discovery and other terminal-host probes in this Matou-managed session.`
